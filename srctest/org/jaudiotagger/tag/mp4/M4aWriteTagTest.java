...
public class M4aWriteTagTest {
    ...
    public void testWriteFileAlotLargerSize() {
        ...
        try {
            ...
            //Lookup by mp4key (no generic key mapping for these yet)
            Assert.assertEquals(" 000002C0 00000298 00004210 00002FD5 0001CB31 0001CB48 0000750D 00007C4A 000291A8 00029191", tag.getFirst(Mp4FieldKey.ITUNES_NORM));
            Assert.assertEquals(" 00000000 00000840 000000E4 0000000000A29EDC 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000", tag.getFirst(Mp4FieldKey.ITUNES_SMPB));
    ...
    public void testDeleteTag() {
        ...
        try {
            ...
            Assert.assertEquals(0, f.getTag().getFieldCount());
        } catch (Exception e) {
            e.printStackTrace();
            exceptionCaught = e;
        }
...
//            Assert.assertEquals(TEST_FILE2_SIZE, testFile.length());
    ...
    public void testWriteFragmented() throws Exception {
        File testFile = AbstractTestCase.copyAudioToTmp("testFragmented.m4a", new File("testFragmentedTemp.m4a"));
        AudioFile f = AudioFileIO.read(testFile);
        Tag tag = f.getTag();
        ...
        Assert.assertEquals(tag.getFirst(FieldKey.ARTIST), "VERYLONGARTISTNAME");
    }
    ...
    public void testWriteGenres() throws Exception {
        File testFile = AbstractTestCase.copyAudioToTmp("test5.m4a", new File("testWriteGenres0.m4a"));
        AudioFile f = AudioFileIO.read(testFile);
        Mp4Tag tag = (Mp4Tag) f.getTag();
    ...
    public void testWriteGenres2() {
        Exception exceptionCaught = null;
        try {
            File testFile = AbstractTestCase.copyAudioToTmp("test5.m4a", new File("testWriteGenres2.m4a"));
            AudioFile f = AudioFileIO.read(testFile);
            Mp4Tag tag = (Mp4Tag) f.getTag();
    ...
    public void testWriteGenres3() throws Exception {
        File testFile = AbstractTestCase.copyAudioToTmp("test5.m4a", new File("testWriteGenres3.m4a"));
        AudioFile f = AudioFileIO.read(testFile);
        Mp4Tag tag = (Mp4Tag) f.getTag();
    ...
    public void testWriteGenres4() {
        Exception exceptionCaught = null;
        try {
            File testFile = AbstractTestCase.copyAudioToTmp("test5.m4a", new File("testWriteGenres4.m4a"));
            AudioFile f = AudioFileIO.read(testFile);
            Mp4Tag tag = (Mp4Tag) f.getTag();
     ...
     */
    @Test
    @Ignore("Changes global constant affecting other tests")
