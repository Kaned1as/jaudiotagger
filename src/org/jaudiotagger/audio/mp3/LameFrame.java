...
public class LameFrame {
    ...
    private LameFrame(ByteBuffer lameHeader) {
        encoder = Utils.getString(lameHeader, 0, ENCODER_SIZE, Charset.forName("ISO-8859-1"));
    }
    ...
    public static LameFrame parseLameFrame(ByteBuffer bb) {
        ...
        String id = Utils.getString(lameHeader, 0, LAME_ID_SIZE, Charset.forName("ISO-8859-1"));
        lameHeader.rewind();
