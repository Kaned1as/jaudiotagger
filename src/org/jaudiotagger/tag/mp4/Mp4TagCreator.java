...
public class Mp4TagCreator extends AbstractTagCreator
{
    ...
    public ByteBuffer convert(Tag tag, int padding) throws UnsupportedEncodingException
    {
        try
        {
            ...
            while (it.hasNext())
            {
                ...
                if (frame instanceof Mp4TagCoverField)
                {
                    ...
                    else
                    {
                        ...
                        baos.write(Mp4FieldKey.ARTWORK.getFieldName().getBytes(Charset.forName("ISO-8859-1")));
                        baos.write(data);
                    }
                }
                else
            ...
            ilst.write(Mp4AtomIdentifier.ILST.getFieldName().getBytes(Charset.forName("ISO-8859-1")));
