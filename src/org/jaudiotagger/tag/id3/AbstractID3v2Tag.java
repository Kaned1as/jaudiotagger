...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag {
    ...
    */
     ...
     * @param bodyBuffer
     */
    private void writeFramesToBufferStream(Map map, ByteArrayOutputStream bodyBuffer) {
    ...
    public TagField createLinkedArtworkField(String url) {
        ...
        if (frame.getBody() instanceof FrameBodyAPIC) {
            ...
            body.setObjectValue(DataTypes.OBJ_PICTURE_DATA, url.getBytes(Charset.forName("ISO-8859-1")));
